    ...
    <div class ="infoNav">
        ...
        <ul class="ulInfoNav">
            ...
            <li class="ulInfoNavLogin">
                    <p>логин:<?= $_SESSION['login']; ?>  <span>в корзине: 0 </span> <span><a href="?logout">  exit</a></span></p>
            </li><?php }?>
...
<div class="headerCategory">
    ...
    <ul class="ulHeaderCategory">
        <li><a class="linkHeadCategory border" href="#">Все разделы</a></li>
        <li><a class="linkHeadCategory border" href="#">Все все акции</a></li>
        <li><a class="linkHeadCategory border" href="#">Телефоны</a></li>
        <li><a class="linkHeadCategory border" href="#">Электроника</a></li>
        <li><a class="linkHeadCategory border" href="#">Бытовая техника</a></li>
